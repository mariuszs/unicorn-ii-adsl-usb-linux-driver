...
bool_t L3_flag = FALSE;	// bool var to acknowledge answer to orderly shutdown request
bool_t g_CheckRetry = FALSE;	// bool var to enable switching to RETRY state when in IDLE
